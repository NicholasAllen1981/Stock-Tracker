'''/*
 * @Author: Nick.Allen 
 * @Date: 2022-11-18 11:05:48 
 * @Last Modified by:   Nick.Allen 
 * @Last Modified time: 2022-11-18 11:05:48 
 */
 # ╔ ╗ ╚ ╝ ═ ║ ╩ ╬  ╢ ─ ╟
'''
# Imports
...
# Retirement_Account class
#   Parent Class
##    Accepts balance and number
...
# Traditional class
#   Child class of Retirement_Account
##   Accepts balance and number
###   functions: Traditional.add_stock(stock_data)
####    Adds stock as traditional account
class Traditional(Retirement_Account):  
    def __init__(self, balance, number): 
        super().__init__(balance, number)
        
    # Traditional Class function to add stock as a traditional account
...
# Robo class
#   Child class of Retirement_Account
##   Accepts balance, number, and years
###   functions: Robo.investment_return 
...
class Robo(Retirement_Account):
    ...
    # Robo class function to calculate the return on investment
