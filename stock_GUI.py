...
class StockApp:
    def __init__(self):
        ...
        # Create Window
        self.root = Tk()
        self.root.title("S.A.M. - Stock Analizing Machine")
    ...
    def add_stock(self):
        new_stock = Stock(self.addSymbolEntry.get().upper(),self.addNameEntry.get().capitalize(),float(self.addSharesEntry.get()))
    ...
    def delete_stock(self):
        if (self.stockList.curselection()):
            ...
            messagebox.showinfo("Stock Deleted!", symbol + " was removed.")
